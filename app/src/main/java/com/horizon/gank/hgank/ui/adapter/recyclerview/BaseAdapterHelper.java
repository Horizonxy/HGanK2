package com.horizon.gank.hgank.ui.adapter.recyclerview;
...
public class BaseAdapterHelper extends RecyclerView.ViewHolder {
    ...
    public BaseAdapterHelper setImageUrl(int viewId, String imageUrl) {
        ImageView view = retrieveView(viewId);
        Application.application.getImageLoader().displayImage(imageUrl, view);
        return this;
    }
    ...
    public BaseAdapterHelper setImageBuilder(int viewId, String imageUrl,
        ...
        ImageView view = retrieveView(viewId);
        Application.application.getImageLoader().displayImage(imageUrl, view, options);
        return this;
    }
